...
namespace unlogic
{
    ...
    public:
        ...
        BinaryNode(std::unique_ptr<Node> lhs, std::unique_ptr<Node> rhs, char operation) : lhs_(std::move(lhs)),
                                                                                           rhs_(std::move(rhs)),
    ...
    public:
        ...
        FunctionDefinitionNode(std::string identifier, std::shared_ptr<Node> body, std::vector<std::string> parameters)
                : identifier_(std::move(identifier)), body_(std::move(body)), parameters_(std::move(parameters))
        {}
    };
    ...
    public:
        ...
        FunctionCallNode(std::string identifier, std::vector<std::unique_ptr<Node>> parameters) : identifier_(
                std::move(identifier)), parameters_(std::move(parameters))
        {}
    };
}
